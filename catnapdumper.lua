-- this file was dumped at SlimTrix Development
local fenv = _ENV or getfenv and getfenv(1) or {}
...
function q.dump_file(eN, eO)
    q.reset()
    az("Generated by Mimic Dumper V2 at https://dsc.gg/mimicyrix [use ai to clean]  \nlocal fenv = getfenv(0.1)\n")
